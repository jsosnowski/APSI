...
\newpage
\begin{enumerate}
  \input{tex/Przypadki_uzycia/Klient/Rejestracja_klienta.tex}
  \input{tex/Przypadki_uzycia/Klient/Zlozenie_zamowienia.tex}
  \input{tex/Przypadki_uzycia/Klient/Edycja_danych_klienta.tex}
  \input{tex/Przypadki_uzycia/Klient/Wyrejestrowanie_sie_klienta.tex}
  \input{tex/Przypadki_uzycia/Klient/Usuniecie_klienta.tex}
\end{enumerate} 